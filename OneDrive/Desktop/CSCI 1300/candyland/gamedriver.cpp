        ...
        if (text_inputs == "y") //anything besides y voids the choice
        {
            ...
            do
            {
                do
                {
                    ...
                    else if (menu_store.findCandyInStore(candy_to_buy.name).name == "Empty"||name_of_candy_to_buy=="Empty"||menu_store.findCandyInStore(candy_to_buy.name).name == "")
                    {
                        found = false;
                    }
    ...
    while (board.getPlayer1Position() < 82 && board.getPlayer2Position() < 82) //checks to make sure the game isn't over
    {
        ...
        if (menuselection == 1)
        {
            ...
            if (playerindex == 0)
            {
                ...
                if (board.getPlayer1Position() >= 82)
                {
                    board.setPlayer1Position(83); //if a player goes over the board, moves them back
                }
                if (board.getPlayer1Position() >= 82)
                {
